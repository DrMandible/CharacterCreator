            ...
            function (_dereq_, module, exports) {
              (function (setImmediate, clearImmediate) {
                (function () {
                   ...
                   * @api public
                   */
                  Tick.prototype.setInterval = function interval(
                    name,
                    fn,
                    time
                  ) {
            ...
            function (_dereq_, module, exports) {
              ...
              function Primus(url, options) {
                ...
                if ("ping" in options || "pong" in options) {
                  return this.critical(
                    new Error("The `ping` and `pong` options have been removed")
                  );
                }
                ...
                options.pingTimeout =
                  "pingTimeout" in options ? options.pingTimeout : 45000;
              ...
              Primus.prototype.client = function client() {
                ...
                primus.on("outgoing::open", function opening() {
                  ...
                  try {
                    var options = {
                      protocol:
                        primus.url.protocol === "ws+unix:" ? "ws+unix:" : "ws:",
                      query: true
                    };
                  ...
                  socket.onmessage = primus.emits(
                    "incoming::data",
                    function parse(next, evt) {
